...
public class GeneratedCode {
	public void runTestCase(){
		...
		* GENERATING DEVICES
		*/
		// packet periocity, firstT1 Time, hardconstraintTime, packetsize
		...
		* GENERATING SWITCHES
		*/
		//max packetsize(1), timetotravel(2), portspeed(3), gbsize(4), cycledurationlowerbound, cycledurationuperbound
