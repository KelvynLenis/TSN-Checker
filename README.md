...
### Ports
This subtopic refers to validations of the ports data. The ports contain some important data for TSNSched like transmission of packets and its cycle and window, those are critical to us as they represent the core of TSN and the Scheduling problem, [see](https://github.com/ACassimiro/TSNsched){:target="_blank"}  for more details about it.
